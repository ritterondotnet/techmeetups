...
T9n = (function() {                                                                                                    // 1
  ...
  T9n.setLanguage = function(language) {                                                                               // 9
    ...
    if (!Object.keys(this.maps[language]).length) {                                                                    // 66
      throw Error("language " + language + " does not exist");                                                         // 67
      return;                                                                                                          // 68
    }                                                                                                                  //
    if (this.language === language) {                                                                                  // 69
      return;                                                                                                          // 69
    }                                                                                                                  //
  ...
  T9n.replaceParams = function(str, args) {                                                                            // 9
    ...
    for (key in args) {                                                                                                // 74
      value = args[key];                                                                                               //
      re = new RegExp("@{" + key + "}", 'g');                                                                          // 75
      str = str.replace(re, value);                                                                                    // 75
    }                                                                                                                  // 74
    return str;                                                                                                        //
  };                                                                                                                   //
                                                                                                                       //
...
de = {                                                                                                                 // 4
  ...
  ifYouAlreadyHaveAnAccount: "Falls noch kein Konto existiert, bitte hier",                                            // 6
...
en = {                                                                                                                 // 3
  ...
  info: {                                                                                                              // 5
    emailSent: "Email sent",                                                                                           // 51
    emailVerified: "Email verified",                                                                                   // 51
    passwordChanged: "Password changed",                                                                               // 51
    passwordReset: "Password reset"                                                                                    // 51
  },                                                                                                                   //
  error: {                                                                                                             // 5
    emailRequired: "Email is required.",                                                                               // 58
    minChar: "7 character minimum password.",                                                                          // 58
    pwdsDontMatch: "Passwords don't match",                                                                            // 58
    pwOneDigit: "Password must have at least one digit.",                                                              // 58
    pwOneLetter: "Password requires 1 letter.",                                                                        // 58
    signInRequired: "You must be signed in to do that.",                                                               // 58
    signupCodeIncorrect: "Registration code is incorrect.",                                                            // 58
    signupCodeRequired: "Registration code is required.",                                                              // 58
    usernameIsEmail: "Username cannot be an email address.",                                                           // 58
    usernameRequired: "Username is required.",                                                                         // 58
    accounts: {                                                                                                        // 58
      "Email already exists.": "Email already exists.",                                                                // 74
      "Email doesn't match the criteria.": "Email doesn't match the criteria.",                                        // 74
      "Invalid login token": "Invalid login token",                                                                    // 74
      "Login forbidden": "Login forbidden",                                                                            // 74
      "Service unknown": "Service unknown",                                                                            // 74
      "Unrecognized options for login request": "Unrecognized options for login request",                              // 74
      "User validation failed": "User validation failed",                                                              // 74
      "Username already exists.": "Username already exists.",                                                          // 74
      "You are not logged in.": "You are not logged in.",                                                              // 74
      "You've been logged out by the server. Please log in again.": "You've been logged out by the server. Please log in again.",
      "Your session has expired. Please log in again.": "Your session has expired. Please log in again.",              // 74
      "Already verified": "Already verified",                                                                          // 74
      "No matching login attempt found": "No matching login attempt found",                                            // 74
      "Password is old. Please reset your password.": "Password is old. Please reset your password.",                  // 74
      "Incorrect password": "Incorrect password",                                                                      // 74
      "Invalid email": "Invalid email",                                                                                // 74
      "Must be logged in": "Must be logged in",                                                                        // 74
      "Need to set a username or email": "Need to set a username or email",                                            // 74
      "old password format": "old password format",                                                                    // 74
      "Password may not be empty": "Password may not be empty",                                                        // 74
      "Signups forbidden": "Signups forbidden",                                                                        // 74
      "Token expired": "Token expired",                                                                                // 74
      "Token has invalid email address": "Token has invalid email address",                                            // 74
      "User has no password set": "User has no password set",                                                          // 74
      "User not found": "User not found",                                                                              // 74
      "Verify email link expired": "Verify email link expired",                                                        // 74
      "Verify email link is for unknown address": "Verify email link is for unknown address",                          // 74
      "At least 1 digit, 1 lowercase and 1 uppercase": "At least 1 digit, 1 lowercase and 1 uppercase",                // 74
      ...
      "Match failed": "Match failed",                                                                                  // 74
      "Unknown error": "Unknown error"                                                                                 // 74
    }                                                                                                                  //
  }                                                                                                                    //
};                                                                                                                     //
                                                                                                                       //
...
it = {                                                                                                                 // 4
  ...
  "with": "con",                                                                                                       // 6
  info: {                                                                                                              // 6
    emailSent: "Email inviata",                                                                                        // 48
    emailVerified: "Email verificata",                                                                                 // 48
    passwordChanged: "Password cambiata",                                                                              // 48
    passwordReset: "Password reimpostata"                                                                              // 48
  },                                                                                                                   //
  error: {                                                                                                             // 6
    emailRequired: "L'Email è obbligatoria.",                                                                          // 55
    minChar: "La Password deve essere di almeno 7 caratteri.",                                                         // 55
    pwdsDontMatch: "Le Password non corrispondono",                                                                    // 55
    pwOneDigit: "La Password deve contenere almeno un numero.",                                                        // 55
    pwOneLetter: "La Password deve contenere 1 lettera.",                                                              // 55
    signInRequired: "Per fare questo devi accedere.",                                                                  // 55
    signupCodeIncorrect: "Codice di Registrazione errato.",                                                            // 55
    signupCodeRequired: "Il Codice di Registrazione è obbligatorio.",                                                  // 55
    usernameIsEmail: "Il Nome Utente non può essere un indirizzo email.",                                              // 55
    usernameRequired: "Il Nome utente è obbligatorio.",                                                                // 55
    accounts: {                                                                                                        // 55
      "Email already exists.": "Indirizzo email già esistente.",                                                       // 72
      "Email doesn't match the criteria.": "L'indirizzo email non soddisfa i requisiti.",                              // 72
      "Invalid login token": "Codice di accesso non valido",                                                           // 72
      "Login forbidden": "Accesso non consentito",                                                                     // 72
      "Service unknown": "Servizio sconosciuto",                                                                       // 72
      "Unrecognized options for login request": "Opzioni per la richiesta di accesso non ricunosciute",                // 72
      "User validation failed": "Validazione utente fallita",                                                          // 72
      "Username already exists.": "Nome utente già esistente.",                                                        // 72
      "You are not logged in.": "Non hai effettuato l'accesso.",                                                       // 72
      "You've been logged out by the server. Please log in again.": "Sei stato disconnesso dal server. Per favore accedi di nuovo.",
      "Your session has expired. Please log in again.": "La tua sessione è scaduta. Per favore accedi di nuovo.",      // 72
      "No matching login attempt found": "Tentativo di accesso corrispondente non trovato",                            // 72
      "Password is old. Please reset your password.": "La password è vecchia. Per favore reimposta la tua password.",  // 72
      "Incorrect password": "Password non corretta",                                                                   // 72
      "Invalid email": "Email non valida",                                                                             // 72
      "Must be logged in": "Devi aver eseguito l'accesso",                                                             // 72
      "Need to set a username or email": "È necessario specificare un nome utente o un indirizzo email",               // 72
      "old password format": "vecchio formato password",                                                               // 72
      "Password may not be empty": "La password non può essere vuota",                                                 // 72
      "Signups forbidden": "Registrazioni non consentite",                                                             // 72
      "Token expired": "Codice scaduto",                                                                               // 72
      "Token has invalid email address": "Il codice ha un indirizzo email non valido",                                 // 72
      "User has no password set": "L'utente non ha una password impostata",                                            // 72
      "User not found": "Utente non trovato",                                                                          // 72
      "Verify email link expired": "Link per la verifica dell'email scaduto",                                          // 72
      "Verify email link is for unknown address": "Il link per la verifica dell'email fa riferimento ad un indirizzo sconosciuto",
      "Match failed": "Riscontro fallito",                                                                             // 72
      "Unknown error": "Errore Sconosciuto"                                                                            // 72
    }                                                                                                                  //
  }                                                                                                                    //
};                                                                                                                     //
                                                                                                                       //
